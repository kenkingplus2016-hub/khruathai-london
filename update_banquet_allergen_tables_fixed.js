...
function replaceModalTextWithTable(filePath) {
    ...
    const regex = /<p style="color: #ddd; font-size: 0\.95rem; line-height: 1\.6;">As our banquets are highly customizable[\s\S]*?<\/p>\s*<p style="color: #ddd; font-size: 0\.95rem; line-height: 1\.6;"><strong>Common Allergens in this menu typically include:[\s\S]*?<\/p>\s*<p style="color: #888; font-size: 0\.8rem; margin-top: 15px;">UK 14 allergens:[\s\S]*?<\/p>/g;

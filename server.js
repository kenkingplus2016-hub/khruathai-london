...
app.post('/api/ai-chat', async (req, res) => {
    try {
        ...
        const prompt = `You are a helpful, polite, and professional AI customer service assistant for a Thai catering business in London called "Khrua Thai" (Khrua Thai London). 
